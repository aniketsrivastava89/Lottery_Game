#Lottery Calculator: Lotteries such as PowerBall 
...
total_numbers=40#Range
number_choices=5 #Number of choices
total_jokerBalls=4 #Number of joker balls
match_numbers=5 #Countr of matched numbers
...
def makeform(root, fields):
    ...
    default_vals=['000','000','000','000','000']
    for field in fields:
        print(field)
        row = tk.Frame(root)
...
text2.insert(tk.END, '\nLottery Prediction\n', 'big')
quote = """
Total Number : Totals numbers in range from which numbers are to be chosen e.g. for range 1-39, Total number = 40
